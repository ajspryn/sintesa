                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="/divisi">Pengaturan </a>
                                    </li>
                ...
                <div class="card">
                    ...
                    @foreach ($divisis as $divisi )
                        <tr>
                            ...
                            <td>
                                <a href="/divisi/{{ $divisi->id }}/edit" type="button" class="btn btn-icon btn-flat-warning">
                                    <span>Edit</span>
                                </a>
                            ...
                            <form method='post' action="/divisi">
                                ...
                                <div class="row d-flex align-items-end">
                                    <div class="col-md-5 col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="itemname">Nama Divisi</label>
                                            <input type="text" class="form-control @error('itemname') is-invalid @enderror" id="itemname" placeholder="Divisi" name="nama_divisi"/>
                                        </div>
                                    </div>
                                </div>
                                <hr />
                            ...
                            <form method='post' action="/divisi/{{ $divisi->id }}">
                                ...
                                <div class="row d-flex align-items-end">
                                    <div class="col-md-5 col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="itemname">Nama Divisi</label>
                                            <input type="text" class="form-control" id="itemname" placeholder="Divisi" name="nama_divisi" value="{{ $divisi->nama_divisi }}"/>
                                        </div>
                                    </div>
                                </div>
                                <hr />
