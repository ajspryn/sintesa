                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active"> Edit Divisi
                                    </li>
                                </ol>
                            </div>
                        </div>
                                    ...
                                    <div class="row d-flex align-items-end">
                                        <div class="col-md-5 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" class="form-control @error('nama_divisi') is-invalid @enderror" id="itemname" placeholder="Divisi" name="nama_divisi" value="{{ $divisi->nama_divisi }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <hr />
