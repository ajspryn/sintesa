                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> Edit Golongan
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method='post' action="/golongan/{{ $golongan->id }}">
                                            @csrf
                                            @method('put')
                                            <div class="row d-flex align-items-end">
                                                <div class="col-md-5 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <input type="text" class="form-control @error('nama_golongan_id') is-invalid @enderror" id="itemname" placeholder="Nama Golongan" name="nama_golongan_id" value="{{ old('nama_golongan_id' , $golongan->nama_golongan_id) }}"/>
                                                    </div>
                                                </div>
