                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="/golongan">Pengaturan </a>
                                </li>
                                <li class="breadcrumb-item active"> Golongan
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <table class="datatables-basic table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ $golongan->nama_golongan_id }}</td>
                                                <td>
                                                    <a href="/golongan/{{ $golongan->id }}/edit" type="button" class="btn btn-icon btn-flat-warning">
                                                        <span>Edit</span>
                                                    </a>
                                                    <form action="/golongan/{{ $golongan->id }}" method="post" class="d-inline" >
                                                        @method('delete')
                                                        @csrf
                                            ...
                                            <div class="row d-flex align-items-end">
                                                <div class="col-md-12 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <input type="text" class="form-control" id="itemname" placeholder="Golongan" name="nama_golongan_id" />
                                                    </div>
                                                </div>
                                            </div>
                                            <hr />
