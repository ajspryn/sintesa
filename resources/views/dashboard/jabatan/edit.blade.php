                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item"><a href="/jabatan">Pengaturan </a>
                                    </li>
                                    <li class="breadcrumb-item active"> Edit Jabatan
                                    </li>
                                </ol>
                            </div>
                        </div>
                                ...
                                <form method='post' action="/jabatan/{{ $jabatan->id }}">
                                    ...
                                    <div class="row d-flex align-items-end">
                                        <div class="col-md-5 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="itemname">Nama Jabatan</label>
                                                <input type="text" class="form-control @error('nama_jabatan') is-invalid @enderror" id="itemname" placeholder="Divisi" name="nama_jabatan" value="{{ $jabatan->nama_jabatan }}"/>
                                            </div>
                                        </div>

                                        <div class="col-md-7 col-12">
                                            <div class="mb-1">
                                                <label class="form-label" for="itemcost">Besaran Tunjangan</label>
                                                <input type="number" class="form-control" id="itemcost" placeholder="Rp." name="tunjangan_jabatan" value="{{ $jabatan->tunjangan_jabatan }}"/>
                                            </div>
                                        </div>
                                    </div>
                                    <hr />
