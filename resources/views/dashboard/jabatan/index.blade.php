                ...
                <div class="card">
                    ...
                    @foreach ($jabatans as $jabatan )
                        <tr>
                            ...
                            <td>
                                <a href="/jabatan/{{ $jabatan->id }}/edit" type="button" class="btn btn-icon btn-flat-warning">
                                    <span>Edit</span>
                                </a>
                                ...
                                <div class="row d-flex align-items-end">
                                    <div class="col-md-5 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control" id="itemname" placeholder="Jabatan" name="nama_jabatan" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-7 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="number" class="form-control" id="itemcost" placeholder="Rp." name="tunjangan_jabatan" />
                                        </div>
                                    </div>
                                </div>
                                <hr />
