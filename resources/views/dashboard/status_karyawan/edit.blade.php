                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> Edit Status
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method='post' action="/status_karyawan/{{ $status_karyawan->id }}">
                                            @csrf
                                            @method('put')
                                            <div class="row d-flex align-items-end">
                                                <div class="col-md-12 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <input type="text" class="form-control @error('nama_status') is-invalid @enderror" id="itemname" placeholder="Status Karyawan" name="nama_status" value="{{ old('nama_status' , $status_karyawan->nama_status) }}"/>
                                                    </div>
                                                </div>
