                                    ...
                                    <table class="datatables-basic table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/pendidikan/{{ $pendidikan->id }}/edit" type="button" class="btn btn-icon btn-flat-warning">
                                                        <span>Edit</span>
                                                    </a>
                                            ...
                                            <div class="row d-flex align-items-end">
                                                <div class="col-md-12 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <input type="text" class="form-control" id="itemname" placeholder="Pendidikan" name="nama_pendidikan" />
                                                    </div>
                                                </div>
                                            </div>
                                            <hr />
