                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> Edit Gaji Pokok
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form method='post' action="/gaji_pokok/{{ $gaji_pokok->id }}">
                                            @csrf
                                            @method('put')
                                            <div class="row d-flex align-items-end">
                                                <div class="col-md-5 col-12">
                                                    <div class="mb-1">
                                                        <label class="form-label" for="itemname">Nama Golongan</label>
                                                        <input type="text" class="form-control @error('nama_golongan_id') is-invalid @enderror" id="itemname" placeholder="Nama Golongan" name="nama_golongan_id" value="{{ old('nama_golongan_id' , $gaji_pokok->nama_golongan_id) }}"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-2 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <input type="text" class="form-control @error('masa_kerja') is-invalid @enderror" id="itemname" placeholder="Tahun" name="masa_kerja" value="{{ old('masa_kerja' , $gaji_pokok->masa_kerja) }}"/>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-5 col-12">
                                                    <div class="mb-1">
                                                        ...
                                                        <input type="number" class="form-control @error('besaran_gaji') is-invalid @enderror" id="itemcost" placeholder="Rp." name="besaran_gaji" value="{{ old('besaran_gaji' , $gaji_pokok->besaran_gaji) }}"/>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr />
